    ...
    >
      {visible.map((shortcut) => (
        <button
          ...
          className="inline-flex shrink-0 items-center gap-2 rounded-full border-0 bg-white/[0.045] px-4 py-2 text-[12px] text-assistant-muted/85 shadow-none outline-none transition-[background-color,color,transform] duration-[180ms] ease-out hover:bg-white/[0.08] hover:text-assistant-text motion-safe:hover:-translate-y-px focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sidian-blue"
        >
          {shortcut.icon ?? (
